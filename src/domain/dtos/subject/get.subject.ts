...
export class GetSubjectDTO{
    ...
    static CreateDTO(object: { [key: string]: any }): [string?, GetSubjectDTO?]{
        const { description, course_id, academic_field_id, stage_id} = object;
        ...
        return [undefined, new GetSubjectDTO(description, course_id_number, academic_field_id_number, stage_id_number)];
    }
    static FindDto(id: number): GetSubjectDTO{

        return new GetSubjectDTO(undefined, undefined, undefined, undefined, id);
    }
}