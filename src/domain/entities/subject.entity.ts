...
export class SubjectEntity {
    ...
    public static fromObject(object: { [key: string]: any }): SubjectEntity {
      const { id, course_id, description, status, precedent, semester, academic_field_id } = object;
      ...
      return new SubjectEntity(id, course_id, description, status,prec, semester, academic_obj);
    }
  }
